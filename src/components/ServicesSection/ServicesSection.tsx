      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm md:text-base text-gray-500 max-w-xl mx-auto">
            Expert guidance tailored to your research needs.
          </p>
        </motion.div>
        ...
        <div className="space-y-12 md:space-y-20">
          {servicesData.map((category, index) => {
            ...
            const mobileGradient = 'bg-gradient-to-b from-blue-50 via-white/80 to-white';
            const desktopGradient = isEven 
              ? 'md:bg-gradient-to-r md:from-blue-50 md:via-white/90 md:to-white' 
              : 'md:bg-gradient-to-l md:from-blue-50 md:via-white/90 md:to-white';
              ...
              >
                ...
                <div className={`w-full md:w-7/12 relative z-10 ${overlapMargin} ${mobileGradient} ${desktopGradient} ${borderRadius}`}>
                  ...
                  <div className={`relative ${contentPadding} text-center ${!isEven ? 'md:text-right' : 'md:text-left'}`}>
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed mb-6 max-w-md mx-auto md:mx-0 inline-block">
                    ...
                    <div className={`flex flex-wrap gap-2 mb-6 justify-center ${!isEven ? 'md:justify-end' : 'md:justify-start'}`}>
                      {category.services.slice(0, 4).map((service) => (
                        <span 
                          key={service.id} 
                          className="text-[10px] md:text-xs font-medium px-2.5 py-1 bg-white border border-gray-100 rounded-full text-gray-600 shadow-sm"
                        >
                          {service.name}
                        </span>
                      ))}
